...
\section{}{Education\hspace{480pt}}
  ...
  \resumeEntryStart
    \resumeEntryTSDL
      {Software Engineering MASc.}{Sep. 2020 -- May. 2024}
...
\section{}{Experience\hspace{473pt}}
  ...
  \resumeItemListStart
      \resumeItem {Tailored software and hardware solutions to fulfill specific customer needs}
      \resumeItem {Implemented image sensor drivers to support new image sensors}
      \resumeItem {Developed tools for extraction, parsing, and verification of embedded data from video streams}
      \resumeItem {Engineered host-side tools to facilitate communication with the camera video processor SoC through I$^2$C}
  ...
  \resumeEntryStart
  \resumeEntryTSDL
    {Graduate Research Assistant}{May 2020 -- Dec. 2022}
    {McMaster Automotive Resource Centre}{Hamilton, ON}
  \resumeItemListStart
      \resumeItem {Collaborated with NXP Semiconductor and an automotive OEM to migrate motor control application to a centralized architecture}
      \resumeItem {Designed firmware for pre-production hardware (NXP S32S \& S32K3), configuring peripherals, clock trees, and pin multiplexing}
      ...
      \resumeItem {Performed signal verification and timing analysis for networking and motor control applications}
  \resumeItemListEnd
  \resumeEntryEnd
  ...
  \resumeEntryStart
    \resumeEntryTSDL
      ...
      \resumeItem {Developed STM32-based CAN drivers for satellite On-Board Computer with (CSP) network stack support}
      \resumeItem {Contributed to the development of FreeRTOS-based flight software for the On-Board Computer in C/C++}
      \resumeItem {Created a prototype Printed Circuit Board using Altium Designer for flight software testing purposes}
    \resumeItemListEnd
  \resumeEntryEnd
  ...
  \resumeEntryTSDL
    ...
    \resumeItemListStart
    \resumeItem {Developed model-based Pacemaker following Boston Scientific specs using MATLAB Simulink on NXP FRDM-K64F}
    \resumeItem {Implemented real-time Pacemaker configuration and monitoring through UART in MATLAB Simulink with a Python GUI}
    \resumeItem {Automated hardware testing with Arm Mbed firmware (C++) and Python scripts utilizing UART communication using STM32F401 and FRDM-K64F}
  \resumeItemListEnd
\resumeEntryEnd
...
\section{}{Skills\hspace{500pt}}
 \resumeEntryStart
  ...
  \resumeEntryS{Software \hspace{34pt}} {MATLAB, Simulink, Altium Designer, Lauterbach TRACE32, STM32CubeMX, Keil $\mu$Vision}
  \resumeEntryS{Hardware \hspace{30pt}} {ARM Cortex-M (STM32F, NXP S32K), ARM Cortex-R (NXP S32S), PowerPC (NXP MPC5), FPGA}
