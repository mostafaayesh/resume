...
\section{}{Experience\hspace{473pt}}
  ...
  \resumeItemListStart
      ...
      \resumeItem {Implemented features within image sensor drivers of a camera video processor SoC}
      \resumeItem {Developed tools for extracting, parsing and verification of embedded data from a video stream}
      \resumeItem {Created host-side tools for communicating with the camera video processor SoC via I$^2$C}
