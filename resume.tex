...
\section{}{Experience\hspace{473pt}}
  ...
  \resumeItemListStart
      ...
      \resumeItem {Performed signal verification and timing analysis for networking and motor control applicationss}
  \resumeItemListEnd
  \resumeEntryEnd
  ...
  \resumeEntryTSDL
    ...
    \resumeItem {Automated hardware testing with Arm Mbed firmware (C++) and Python scripts utilizing UART communication}
  \resumeItemListEnd
\resumeEntryEnd
