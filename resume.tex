...
\section{}{Experience\hspace{473pt}}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {Developed CAN drivers for the satellite’s On-Board Computer and integrated them into a network stack (CSP)}
      \resumeItem {Contributed to the development of the On-Board Computer's flight software in C running on FreeRTOS}
...
\section{}{Projects\hspace{490pt}}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {A Cross-Platform mobile app (iOS \& Android) that allows the user to search for books by using a picture of the book using Google Cloud Services.}
    \resumeItemListEnd
  \resumeEntryEnd
  % \vspace{-2pt}
%-------------------------------------------------- PROGRAMMING SKILLS --------------------------------------------------
\section{}{Skills\hspace{500pt}}
 \resumeEntryStart
  ...
  \resumeEntryS{Software \hspace{34pt}} {MATLAB, Simulink, Altium Designer, Lauterbach TRACE32}
