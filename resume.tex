...
\section{}{Experience\hspace{473pt}}
  ...
  \resumeItemListStart
      ...
      \resumeItem {Developed drivers supporting new image sensors and serializers/deserializers}
  ...
  \resumeEntryStart
  \resumeEntryTSDL
    {Researcher - Embedded Systems}{May 2020 -- Dec. 2022}
  ...
  \resumeItemListStart
      ...
      \resumeItem {Migrated a production decentralized motor control application to a real-time centralized architecture}
      \resumeItem {Implemented precise time synchronization using Time Sensitive Networking (TSN) over Automotive Ethernet}
...
\section{}{Projects\hspace{490pt}}
  ...
  \resumeEntryStart
    \resumeEntryTD
      {Booky}{Jan. 2018}
    \resumeItemListStart
      \resumeItem {Developed a Cross-Platform mobile app available on iOS \& Android, enabling users to find books using cover images}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {Led the design and construction of a Sumobot, selecting components and building the electrical circuitry}
      \resumeItem {Developed a C++ Arduino project, implementing motor control and sensor sampling functionalities, including line detection and ultrasound sensing}
    \resumeItemListEnd
  \resumeEntryEnd
